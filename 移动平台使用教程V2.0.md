...
flow
st=>start: start
op0=>operation: 点击有线连接
op1=>operation: 点击编辑连接
op2=>operation: 点击以太网下的有线连接
op3=>operation: 点击增加
op4=>operation: 选择连接类型，选择以太网
op5=>operation: 点击新建
op6=>operation: 点击IPV4设置（可以自己改连接名称）
op7=>operation: 方法：手动
op8=>operation: 地址：192.168.131.50；子网掩码：255.255.255.0；网关：192.168.131.1
op9=>e: 点击保存
e=>end
st->op0->op1->op2->op3->op4->op5->op6->op7->op8->op9->e 
```
